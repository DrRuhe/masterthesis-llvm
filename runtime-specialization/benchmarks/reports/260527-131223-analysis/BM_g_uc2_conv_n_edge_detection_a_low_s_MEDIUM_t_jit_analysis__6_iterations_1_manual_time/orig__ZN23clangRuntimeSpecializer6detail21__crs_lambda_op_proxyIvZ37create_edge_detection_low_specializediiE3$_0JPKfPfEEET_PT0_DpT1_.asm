...
mov %rdx,%rsi
mov %eax,%edx
jmp 4f81910 <_Z17sobel_edge_detectPKfPfii>
int3
int3
int3
int3
...
mov %rsi,-0x30(%rsp)
test %ecx,%ecx
jle 4f81bae <_Z17sobel_edge_detectPKfPfii+0x29e>
cmpl $0x0,-0x40(%rsp)
jle 4f81bae <_Z17sobel_edge_detectPKfPfii+0x29e>
mov %ecx,%edx
mov -0x40(%rsp),%rcx
...
lea -0x1(%rcx),%r11
xor %ebx,%ebx
movss -0x4e8b40(%rip),%xmm0 # 4a98e30 <.LCPI0_0>
mov -0x30(%rsp),%r14
xor %esi,%esi
jmp 4f81a7e <_Z17sobel_edge_detectPKfPfii+0x16e>
nopl 0x0(%rax)
xor %r8d,%r8d
mov -0x8(%rsp),%r12
imul -0x18(%rsp),%r12
...
mov %rcx,%rsi
cmp -0x20(%rsp),%rcx
je 4f81bae <_Z17sobel_edge_detectPKfPfii+0x29e>
lea -0x1(%rsi),%ebp
mov -0x34(%rsp),%ecx
cmp %ecx,%ebp
cmovge %ecx,%ebp
...
imul %edx,%ecx
test %eax,%eax
je 4f81980 <_Z17sobel_edge_detectPKfPfii+0x70>
xor %r13d,%r13d
lea -0x1(%r13),%esi
cmp %eax,%esi
cmovge %eax,%esi
...
mov %r8,%r13
cmp %r8,%r11
jne 4f81ad0 <_Z17sobel_edge_detectPKfPfii+0x1c0>
jmp 4f81983 <_Z17sobel_edge_detectPKfPfii+0x73>
pop %rbx
pop %r12
pop %r13
pop %r14
