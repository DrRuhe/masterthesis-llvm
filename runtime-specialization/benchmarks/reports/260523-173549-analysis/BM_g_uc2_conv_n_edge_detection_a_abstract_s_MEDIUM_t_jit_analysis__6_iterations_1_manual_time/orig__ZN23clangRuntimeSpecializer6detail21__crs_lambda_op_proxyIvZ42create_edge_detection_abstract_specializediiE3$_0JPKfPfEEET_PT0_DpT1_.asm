...
mov (%rdi),%ecx
mov 0x4(%rdi),%r8d
lea 0x22693b2(%rip),%rax # 71dc050 <_ZTV13SobelDetector>
add $0x10,%rax
mov %rax,(%rsp)
mov %rsp,%rdi
call 4f716c0 <_ZN13SobelDetector6detectEPKfPfii>
pop %rax
ret
<_ZN13SobelDetector6detectEPKfPfii>:
push %rbp
push %r15
push %r14
push %r13
...
mov %rdx,-0x28(%rsp)
test %r8d,%r8d
jle 4f719fc <_ZN13SobelDetector6detectEPKfPfii+0x33c>
cmpl $0x0,-0x38(%rsp)
jle 4f719fc <_ZN13SobelDetector6detectEPKfPfii+0x33c>
mov %r8d,%ecx
mov -0x38(%rsp),%rdx
...
mov -0x28(%rsp),%r14
xor %r8d,%r8d
jmp 4f71874 <_ZN13SobelDetector6detectEPKfPfii+0x1b4>
nopl 0x0(%rax,%rax,1)
xor %edi,%edi
imul -0x10(%rsp),%r8
lea -0x1(%rdi),%edx
...
mov %rcx,%r8
cmp -0x18(%rsp),%rcx
je 4f719fc <_ZN13SobelDetector6detectEPKfPfii+0x33c>
lea -0x1(%r8),%r10d
mov -0x2c(%rsp),%ebp
cmp %ebp,%r10d
cmovge %ebp,%r10d
...
imul %ecx,%ebp
test %eax,%eax
je 4f71730 <_ZN13SobelDetector6detectEPKfPfii+0x70>
xor %r13d,%r13d
nopl 0x0(%rax)
lea -0x1(%r13),%edx
cmp %eax,%edx
...
mov %rdi,%r13
cmp %rdi,%r11
jne 4f718d0 <_ZN13SobelDetector6detectEPKfPfii+0x210>
jmp 4f71732 <_ZN13SobelDetector6detectEPKfPfii+0x72>
pop %rbx
pop %r12
pop %r13
pop %r14
