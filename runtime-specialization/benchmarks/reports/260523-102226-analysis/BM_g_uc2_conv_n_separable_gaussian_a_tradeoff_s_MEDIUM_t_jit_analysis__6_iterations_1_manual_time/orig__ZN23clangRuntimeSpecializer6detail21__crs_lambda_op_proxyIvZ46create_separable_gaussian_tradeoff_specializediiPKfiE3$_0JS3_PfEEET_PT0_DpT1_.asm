...
call 4da98e0 <_ZNSt3__120__throw_length_errorB8ne180100EPKc>
int3
int3
int3
<_ZdlPvm>:
...
mov %rax,%rdi
mov %r14,%rsi
call 4da9930 <_ZNSt12length_errorC2B8ne180100EPKc>
lea 0x24e1faa(%rip),%rsi # 728b8b0 <_ZTVN10__cxxabiv120__si_class_type_infoE@Base>
lea 0x24064a3(%rip),%rdx # 71afdb0 <_ZNSt12length_errorD1Ev>
mov %rbx,%rdi
...
lea 0x24e2078(%rip),%rax # 728b9b8 <_ZTVSt12length_error>
add $0x10,%rax
mov %rax,(%rbx)
pop %rbx
ret
