...
BENCHMARK(BM_UC2_jit_overhead)->Name("BM_g:uc2_conv;n:separable_gaussian;a:low;s:SMALL;t:jit_overhead;")->SMALL->Iterations(1)->UseManualTime()->Setup(setup_uc2)->Teardown(teardown_uc2); \
BENCHMARK(BM_UC2_jit_overhead)->Name("BM_g:uc2_conv;n:separable_gaussian;a:low;s:MEDIUM;t:jit_overhead;")->MEDIUM->Iterations(1)->UseManualTime()->Setup(setup_uc2)->Teardown(teardown_uc2); \
BENCHMARK(BM_UC2_jit_overhead)->Name("BM_g:uc2_conv;n:separable_gaussian;a:low;s:LARGE;t:jit_overhead;")->LARGE->Iterations(1)->UseManualTime()->Setup(setup_uc2)->Teardown(teardown_uc2); \
BENCHMARK(BM_UC2_jit_overhead)->Name("BM_g:uc2_conv;n:separable_gaussian;a:low;s:EXTRALARGE;t:jit_overhead;")->EXTRALARGE->Iterations(1)->UseManualTime()->Setup(setup_uc2)->Teardown(teardown_uc2); \
...
BENCHMARK(BM_UC2_box_filter_low_jit_overhead)->Name("BM_g:uc2_conv;n:box_filter;a:low;s:SMALL;t:jit_overhead;")->SMALL->Iterations(1)->UseManualTime()->Setup(setup_uc2)->Teardown(teardown_uc2); \
BENCHMARK(BM_UC2_box_filter_low_jit_overhead)->Name("BM_g:uc2_conv;n:box_filter;a:low;s:MEDIUM;t:jit_overhead;")->MEDIUM->Iterations(1)->UseManualTime()->Setup(setup_uc2)->Teardown(teardown_uc2); \
BENCHMARK(BM_UC2_box_filter_low_jit_overhead)->Name("BM_g:uc2_conv;n:box_filter;a:low;s:LARGE;t:jit_overhead;")->LARGE->Iterations(1)->UseManualTime()->Setup(setup_uc2)->Teardown(teardown_uc2); \
BENCHMARK(BM_UC2_box_filter_low_jit_overhead)->Name("BM_g:uc2_conv;n:box_filter;a:low;s:EXTRALARGE;t:jit_overhead;")->EXTRALARGE->Iterations(1)->UseManualTime()->Setup(setup_uc2)->Teardown(teardown_uc2); \
...
BENCHMARK(BM_UC2_edge_detection_low_jit_overhead)->Name("BM_g:uc2_conv;n:edge_detection;a:low;s:SMALL;t:jit_overhead;")->SMALL->Iterations(1)->UseManualTime()->Setup(setup_uc2)->Teardown(teardown_uc2); \
BENCHMARK(BM_UC2_edge_detection_low_jit_overhead)->Name("BM_g:uc2_conv;n:edge_detection;a:low;s:MEDIUM;t:jit_overhead;")->MEDIUM->Iterations(1)->UseManualTime()->Setup(setup_uc2)->Teardown(teardown_uc2); \
BENCHMARK(BM_UC2_edge_detection_low_jit_overhead)->Name("BM_g:uc2_conv;n:edge_detection;a:low;s:LARGE;t:jit_overhead;")->LARGE->Iterations(1)->UseManualTime()->Setup(setup_uc2)->Teardown(teardown_uc2); \
BENCHMARK(BM_UC2_edge_detection_low_jit_overhead)->Name("BM_g:uc2_conv;n:edge_detection;a:low;s:EXTRALARGE;t:jit_overhead;")->EXTRALARGE->Iterations(1)->UseManualTime()->Setup(setup_uc2)->Teardown(teardown_uc2); \
...
BENCHMARK(BM_UC2_sg_tradeoff_jit_overhead)->Name("BM_g:uc2_conv;n:separable_gaussian;a:tradeoff;s:SMALL;t:jit_overhead;")->SMALL->Iterations(1)->UseManualTime()->Setup(setup_uc2)->Teardown(teardown_uc2); \
BENCHMARK(BM_UC2_sg_tradeoff_jit_overhead)->Name("BM_g:uc2_conv;n:separable_gaussian;a:tradeoff;s:MEDIUM;t:jit_overhead;")->MEDIUM->Iterations(1)->UseManualTime()->Setup(setup_uc2)->Teardown(teardown_uc2); \
BENCHMARK(BM_UC2_sg_tradeoff_jit_overhead)->Name("BM_g:uc2_conv;n:separable_gaussian;a:tradeoff;s:LARGE;t:jit_overhead;")->LARGE->Iterations(1)->UseManualTime()->Setup(setup_uc2)->Teardown(teardown_uc2); \
BENCHMARK(BM_UC2_sg_tradeoff_jit_overhead)->Name("BM_g:uc2_conv;n:separable_gaussian;a:tradeoff;s:EXTRALARGE;t:jit_overhead;")->EXTRALARGE->Iterations(1)->UseManualTime()->Setup(setup_uc2)->Teardown(teardown_uc2); \
...
BENCHMARK(BM_UC2_box_filter_tradeoff_jit_overhead)->Name("BM_g:uc2_conv;n:box_filter;a:tradeoff;s:SMALL;t:jit_overhead;")->SMALL->Iterations(1)->UseManualTime()->Setup(setup_uc2)->Teardown(teardown_uc2); \
BENCHMARK(BM_UC2_box_filter_tradeoff_jit_overhead)->Name("BM_g:uc2_conv;n:box_filter;a:tradeoff;s:MEDIUM;t:jit_overhead;")->MEDIUM->Iterations(1)->UseManualTime()->Setup(setup_uc2)->Teardown(teardown_uc2); \
BENCHMARK(BM_UC2_box_filter_tradeoff_jit_overhead)->Name("BM_g:uc2_conv;n:box_filter;a:tradeoff;s:LARGE;t:jit_overhead;")->LARGE->Iterations(1)->UseManualTime()->Setup(setup_uc2)->Teardown(teardown_uc2); \
BENCHMARK(BM_UC2_box_filter_tradeoff_jit_overhead)->Name("BM_g:uc2_conv;n:box_filter;a:tradeoff;s:EXTRALARGE;t:jit_overhead;")->EXTRALARGE->Iterations(1)->UseManualTime()->Setup(setup_uc2)->Teardown(teardown_uc2); \
...
BENCHMARK(BM_UC2_edge_detection_tradeoff_jit_overhead)->Name("BM_g:uc2_conv;n:edge_detection;a:tradeoff;s:SMALL;t:jit_overhead;")->SMALL->Iterations(1)->UseManualTime()->Setup(setup_uc2)->Teardown(teardown_uc2); \
BENCHMARK(BM_UC2_edge_detection_tradeoff_jit_overhead)->Name("BM_g:uc2_conv;n:edge_detection;a:tradeoff;s:MEDIUM;t:jit_overhead;")->MEDIUM->Iterations(1)->UseManualTime()->Setup(setup_uc2)->Teardown(teardown_uc2); \
BENCHMARK(BM_UC2_edge_detection_tradeoff_jit_overhead)->Name("BM_g:uc2_conv;n:edge_detection;a:tradeoff;s:LARGE;t:jit_overhead;")->LARGE->Iterations(1)->UseManualTime()->Setup(setup_uc2)->Teardown(teardown_uc2); \
BENCHMARK(BM_UC2_edge_detection_tradeoff_jit_overhead)->Name("BM_g:uc2_conv;n:edge_detection;a:tradeoff;s:EXTRALARGE;t:jit_overhead;")->EXTRALARGE->Iterations(1)->UseManualTime()->Setup(setup_uc2)->Teardown(teardown_uc2); \
...
BENCHMARK(BM_UC2_sg_abstract_jit_overhead)->Name("BM_g:uc2_conv;n:separable_gaussian;a:abstract;s:SMALL;t:jit_overhead;")->SMALL->Iterations(1)->UseManualTime()->Setup(setup_uc2)->Teardown(teardown_uc2); \
BENCHMARK(BM_UC2_sg_abstract_jit_overhead)->Name("BM_g:uc2_conv;n:separable_gaussian;a:abstract;s:MEDIUM;t:jit_overhead;")->MEDIUM->Iterations(1)->UseManualTime()->Setup(setup_uc2)->Teardown(teardown_uc2); \
BENCHMARK(BM_UC2_sg_abstract_jit_overhead)->Name("BM_g:uc2_conv;n:separable_gaussian;a:abstract;s:LARGE;t:jit_overhead;")->LARGE->Iterations(1)->UseManualTime()->Setup(setup_uc2)->Teardown(teardown_uc2); \
BENCHMARK(BM_UC2_sg_abstract_jit_overhead)->Name("BM_g:uc2_conv;n:separable_gaussian;a:abstract;s:EXTRALARGE;t:jit_overhead;")->EXTRALARGE->Iterations(1)->UseManualTime()->Setup(setup_uc2)->Teardown(teardown_uc2); \
...
BENCHMARK(BM_UC2_box_filter_abstract_jit_overhead)->Name("BM_g:uc2_conv;n:box_filter;a:abstract;s:SMALL;t:jit_overhead;")->SMALL->Iterations(1)->UseManualTime()->Setup(setup_uc2)->Teardown(teardown_uc2); \
BENCHMARK(BM_UC2_box_filter_abstract_jit_overhead)->Name("BM_g:uc2_conv;n:box_filter;a:abstract;s:MEDIUM;t:jit_overhead;")->MEDIUM->Iterations(1)->UseManualTime()->Setup(setup_uc2)->Teardown(teardown_uc2); \
BENCHMARK(BM_UC2_box_filter_abstract_jit_overhead)->Name("BM_g:uc2_conv;n:box_filter;a:abstract;s:LARGE;t:jit_overhead;")->LARGE->Iterations(1)->UseManualTime()->Setup(setup_uc2)->Teardown(teardown_uc2); \
BENCHMARK(BM_UC2_box_filter_abstract_jit_overhead)->Name("BM_g:uc2_conv;n:box_filter;a:abstract;s:EXTRALARGE;t:jit_overhead;")->EXTRALARGE->Iterations(1)->UseManualTime()->Setup(setup_uc2)->Teardown(teardown_uc2); \
...
BENCHMARK(BM_UC2_edge_detection_abstract_jit_overhead)->Name("BM_g:uc2_conv;n:edge_detection;a:abstract;s:SMALL;t:jit_overhead;")->SMALL->Iterations(1)->UseManualTime()->Setup(setup_uc2)->Teardown(teardown_uc2); \
BENCHMARK(BM_UC2_edge_detection_abstract_jit_overhead)->Name("BM_g:uc2_conv;n:edge_detection;a:abstract;s:MEDIUM;t:jit_overhead;")->MEDIUM->Iterations(1)->UseManualTime()->Setup(setup_uc2)->Teardown(teardown_uc2); \
BENCHMARK(BM_UC2_edge_detection_abstract_jit_overhead)->Name("BM_g:uc2_conv;n:edge_detection;a:abstract;s:LARGE;t:jit_overhead;")->LARGE->Iterations(1)->UseManualTime()->Setup(setup_uc2)->Teardown(teardown_uc2); \
BENCHMARK(BM_UC2_edge_detection_abstract_jit_overhead)->Name("BM_g:uc2_conv;n:edge_detection;a:abstract;s:EXTRALARGE;t:jit_overhead;")->EXTRALARGE->Iterations(1)->UseManualTime()->Setup(setup_uc2)->Teardown(teardown_uc2); \
