...
BENCHMARK(BM_UC1_count_matching_rows_low_jit_overhead)->Name("BM_g:uc1_sql;n:count_matching_rows;a:low;s:SMALL;t:jit_overhead;")->SMALL->Setup(setup_uc1)->Teardown(teardown_uc1)->Unit(benchmark::kMillisecond); \
BENCHMARK(BM_UC1_count_matching_rows_low_jit_overhead)->Name("BM_g:uc1_sql;n:count_matching_rows;a:low;s:MEDIUM;t:jit_overhead;")->MEDIUM->Setup(setup_uc1)->Teardown(teardown_uc1)->Unit(benchmark::kMillisecond); \
BENCHMARK(BM_UC1_count_matching_rows_low_jit_overhead)->Name("BM_g:uc1_sql;n:count_matching_rows;a:low;s:LARGE;t:jit_overhead;")->LARGE->Setup(setup_uc1)->Teardown(teardown_uc1)->Unit(benchmark::kMillisecond); \
BENCHMARK(BM_UC1_count_matching_rows_low_jit_overhead)->Name("BM_g:uc1_sql;n:count_matching_rows;a:low;s:EXTRALARGE;t:jit_overhead;")->EXTRALARGE->Setup(setup_uc1)->Teardown(teardown_uc1)->Unit(benchmark::kMillisecond); \
...
BENCHMARK(BM_UC1_count_matching_rows_tradeoff_jit_overhead)->Name("BM_g:uc1_sql;n:count_matching_rows;a:tradeoff;s:SMALL;t:jit_overhead;")->SMALL->Setup(setup_uc1)->Teardown(teardown_uc1)->Unit(benchmark::kMillisecond); \
BENCHMARK(BM_UC1_count_matching_rows_tradeoff_jit_overhead)->Name("BM_g:uc1_sql;n:count_matching_rows;a:tradeoff;s:MEDIUM;t:jit_overhead;")->MEDIUM->Setup(setup_uc1)->Teardown(teardown_uc1)->Unit(benchmark::kMillisecond); \
BENCHMARK(BM_UC1_count_matching_rows_tradeoff_jit_overhead)->Name("BM_g:uc1_sql;n:count_matching_rows;a:tradeoff;s:LARGE;t:jit_overhead;")->LARGE->Setup(setup_uc1)->Teardown(teardown_uc1)->Unit(benchmark::kMillisecond); \
BENCHMARK(BM_UC1_count_matching_rows_tradeoff_jit_overhead)->Name("BM_g:uc1_sql;n:count_matching_rows;a:tradeoff;s:EXTRALARGE;t:jit_overhead;")->EXTRALARGE->Setup(setup_uc1)->Teardown(teardown_uc1)->Unit(benchmark::kMillisecond); \
...
BENCHMARK(BM_UC1_count_matching_rows_abstract_jit_overhead)->Name("BM_g:uc1_sql;n:count_matching_rows;a:abstract;s:SMALL;t:jit_overhead;")->SMALL->Setup(setup_uc1)->Teardown(teardown_uc1)->Unit(benchmark::kMillisecond); \
BENCHMARK(BM_UC1_count_matching_rows_abstract_jit_overhead)->Name("BM_g:uc1_sql;n:count_matching_rows;a:abstract;s:MEDIUM;t:jit_overhead;")->MEDIUM->Setup(setup_uc1)->Teardown(teardown_uc1)->Unit(benchmark::kMillisecond); \
BENCHMARK(BM_UC1_count_matching_rows_abstract_jit_overhead)->Name("BM_g:uc1_sql;n:count_matching_rows;a:abstract;s:LARGE;t:jit_overhead;")->LARGE->Setup(setup_uc1)->Teardown(teardown_uc1)->Unit(benchmark::kMillisecond); \
BENCHMARK(BM_UC1_count_matching_rows_abstract_jit_overhead)->Name("BM_g:uc1_sql;n:count_matching_rows;a:abstract;s:EXTRALARGE;t:jit_overhead;")->EXTRALARGE->Setup(setup_uc1)->Teardown(teardown_uc1)->Unit(benchmark::kMillisecond); \
...
BENCHMARK(BM_UC1_multi_predicate_low_jit_overhead)->Name("BM_g:uc1_sql;n:multi_predicate;a:low;s:SMALL;t:jit_overhead;")->SMALL->Setup(setup_uc1)->Teardown(teardown_uc1)->Unit(benchmark::kMillisecond); \
BENCHMARK(BM_UC1_multi_predicate_low_jit_overhead)->Name("BM_g:uc1_sql;n:multi_predicate;a:low;s:MEDIUM;t:jit_overhead;")->MEDIUM->Setup(setup_uc1)->Teardown(teardown_uc1)->Unit(benchmark::kMillisecond); \
BENCHMARK(BM_UC1_multi_predicate_low_jit_overhead)->Name("BM_g:uc1_sql;n:multi_predicate;a:low;s:LARGE;t:jit_overhead;")->LARGE->Setup(setup_uc1)->Teardown(teardown_uc1)->Unit(benchmark::kMillisecond); \
BENCHMARK(BM_UC1_multi_predicate_low_jit_overhead)->Name("BM_g:uc1_sql;n:multi_predicate;a:low;s:EXTRALARGE;t:jit_overhead;")->EXTRALARGE->Setup(setup_uc1)->Teardown(teardown_uc1)->Unit(benchmark::kMillisecond); \
...
BENCHMARK(BM_UC1_multi_predicate_tradeoff_jit_overhead)->Name("BM_g:uc1_sql;n:multi_predicate;a:tradeoff;s:SMALL;t:jit_overhead;")->SMALL->Setup(setup_uc1)->Teardown(teardown_uc1)->Unit(benchmark::kMillisecond); \
BENCHMARK(BM_UC1_multi_predicate_tradeoff_jit_overhead)->Name("BM_g:uc1_sql;n:multi_predicate;a:tradeoff;s:MEDIUM;t:jit_overhead;")->MEDIUM->Setup(setup_uc1)->Teardown(teardown_uc1)->Unit(benchmark::kMillisecond); \
BENCHMARK(BM_UC1_multi_predicate_tradeoff_jit_overhead)->Name("BM_g:uc1_sql;n:multi_predicate;a:tradeoff;s:LARGE;t:jit_overhead;")->LARGE->Setup(setup_uc1)->Teardown(teardown_uc1)->Unit(benchmark::kMillisecond); \
BENCHMARK(BM_UC1_multi_predicate_tradeoff_jit_overhead)->Name("BM_g:uc1_sql;n:multi_predicate;a:tradeoff;s:EXTRALARGE;t:jit_overhead;")->EXTRALARGE->Setup(setup_uc1)->Teardown(teardown_uc1)->Unit(benchmark::kMillisecond); \
...
BENCHMARK(BM_UC1_multi_predicate_abstract_jit_overhead)->Name("BM_g:uc1_sql;n:multi_predicate;a:abstract;s:SMALL;t:jit_overhead;")->SMALL->Setup(setup_uc1)->Teardown(teardown_uc1)->Unit(benchmark::kMillisecond); \
BENCHMARK(BM_UC1_multi_predicate_abstract_jit_overhead)->Name("BM_g:uc1_sql;n:multi_predicate;a:abstract;s:MEDIUM;t:jit_overhead;")->MEDIUM->Setup(setup_uc1)->Teardown(teardown_uc1)->Unit(benchmark::kMillisecond); \
BENCHMARK(BM_UC1_multi_predicate_abstract_jit_overhead)->Name("BM_g:uc1_sql;n:multi_predicate;a:abstract;s:LARGE;t:jit_overhead;")->LARGE->Setup(setup_uc1)->Teardown(teardown_uc1)->Unit(benchmark::kMillisecond); \
BENCHMARK(BM_UC1_multi_predicate_abstract_jit_overhead)->Name("BM_g:uc1_sql;n:multi_predicate;a:abstract;s:EXTRALARGE;t:jit_overhead;")->EXTRALARGE->Setup(setup_uc1)->Teardown(teardown_uc1)->Unit(benchmark::kMillisecond); \
...
BENCHMARK(BM_UC1_column_scan_low_jit_overhead)->Name("BM_g:uc1_sql;n:column_scan;a:low;s:SMALL;t:jit_overhead;")->SMALL->Setup(setup_uc1)->Teardown(teardown_uc1)->Unit(benchmark::kMillisecond); \
BENCHMARK(BM_UC1_column_scan_low_jit_overhead)->Name("BM_g:uc1_sql;n:column_scan;a:low;s:MEDIUM;t:jit_overhead;")->MEDIUM->Setup(setup_uc1)->Teardown(teardown_uc1)->Unit(benchmark::kMillisecond); \
BENCHMARK(BM_UC1_column_scan_low_jit_overhead)->Name("BM_g:uc1_sql;n:column_scan;a:low;s:LARGE;t:jit_overhead;")->LARGE->Setup(setup_uc1)->Teardown(teardown_uc1)->Unit(benchmark::kMillisecond); \
BENCHMARK(BM_UC1_column_scan_low_jit_overhead)->Name("BM_g:uc1_sql;n:column_scan;a:low;s:EXTRALARGE;t:jit_overhead;")->EXTRALARGE->Setup(setup_uc1)->Teardown(teardown_uc1)->Unit(benchmark::kMillisecond); \
...
BENCHMARK(BM_UC1_column_scan_tradeoff_jit_overhead)->Name("BM_g:uc1_sql;n:column_scan;a:tradeoff;s:SMALL;t:jit_overhead;")->SMALL->Setup(setup_uc1)->Teardown(teardown_uc1)->Unit(benchmark::kMillisecond); \
BENCHMARK(BM_UC1_column_scan_tradeoff_jit_overhead)->Name("BM_g:uc1_sql;n:column_scan;a:tradeoff;s:MEDIUM;t:jit_overhead;")->MEDIUM->Setup(setup_uc1)->Teardown(teardown_uc1)->Unit(benchmark::kMillisecond); \
BENCHMARK(BM_UC1_column_scan_tradeoff_jit_overhead)->Name("BM_g:uc1_sql;n:column_scan;a:tradeoff;s:LARGE;t:jit_overhead;")->LARGE->Setup(setup_uc1)->Teardown(teardown_uc1)->Unit(benchmark::kMillisecond); \
BENCHMARK(BM_UC1_column_scan_tradeoff_jit_overhead)->Name("BM_g:uc1_sql;n:column_scan;a:tradeoff;s:EXTRALARGE;t:jit_overhead;")->EXTRALARGE->Setup(setup_uc1)->Teardown(teardown_uc1)->Unit(benchmark::kMillisecond); \
...
BENCHMARK(BM_UC1_column_scan_abstract_jit_overhead)->Name("BM_g:uc1_sql;n:column_scan;a:abstract;s:SMALL;t:jit_overhead;")->SMALL->Setup(setup_uc1)->Teardown(teardown_uc1)->Unit(benchmark::kMillisecond); \
BENCHMARK(BM_UC1_column_scan_abstract_jit_overhead)->Name("BM_g:uc1_sql;n:column_scan;a:abstract;s:MEDIUM;t:jit_overhead;")->MEDIUM->Setup(setup_uc1)->Teardown(teardown_uc1)->Unit(benchmark::kMillisecond); \
BENCHMARK(BM_UC1_column_scan_abstract_jit_overhead)->Name("BM_g:uc1_sql;n:column_scan;a:abstract;s:LARGE;t:jit_overhead;")->LARGE->Setup(setup_uc1)->Teardown(teardown_uc1)->Unit(benchmark::kMillisecond); \
BENCHMARK(BM_UC1_column_scan_abstract_jit_overhead)->Name("BM_g:uc1_sql;n:column_scan;a:abstract;s:EXTRALARGE;t:jit_overhead;")->EXTRALARGE->Setup(setup_uc1)->Teardown(teardown_uc1)->Unit(benchmark::kMillisecond); \
