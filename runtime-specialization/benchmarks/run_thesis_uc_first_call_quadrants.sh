...
FILTER='BM_g:(uc1|uc2|uc7|uc8|uc12|uc14)_[a-z]+;.*a:(low|abstract|tradeoff);.*s:(SMALL|MEDIUM|LARGE|EXTRALARGE);.*t:(jit_overhead|specialized_exec|unspecialized)'
