...
// RUN: CRS_DEFAULT_PIPELINE=1 %t.exe 1 2>&1 | FileCheck %s --check-prefix=EXE --dump-input=always
...
// RUN: CRS_DEFAULT_PIPELINE=1 %t.o3.exe 1 2>&1 | FileCheck %s --check-prefix=EXE --dump-input=always
